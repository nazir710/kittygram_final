...
## Описание CI/CD:
1) Для деплоя проекта на сервер используется GitHub Actions. Деплой происходит в следующем порядке:
...
2) Для настройки деплоя необходимо настроить следующие секреты в GitHub Actions:
